...
def create_generatorsX(checkpoint):
    # Creating generators
    ...
    return generatorX, generatorX_

def create_generatorsY(checkpoint):
    ...
    return generatorY, generatorY_


    #create discriminators
def create_dixcriminators(checkpoint):
    ...
    return discriminatorX,discriminatorY
...
class CycleGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['D_Y', 'G_X', 'cycle_X', 'idt_X', 'D_X', 'G_Y', 'cycle_Y', 'idt_Y']
        ...
        if self.isTrain:
            self.model_names = ['G_X', 'G_Y','G_X_', 'G_Y_', 'D_Y', 'D_X']
        ...
        self.netG_X,self.netG_x_ = create_generatorsX()
        self.netG_Y,self.netG_Y_ = networks.define_G(opt.output_nc, opt.input_nc, opt.ngf, opt.netG, opt.norm,
